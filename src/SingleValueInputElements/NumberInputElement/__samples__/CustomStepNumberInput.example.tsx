...
export default class CustomStepNumberInputSample extends React.Component {
    ...
    public constructor(props: unknown) {
        ...
        this._numberInput = new SingleValueInputElement<number, INumberInputProps>(
            { isRequired: true, label: 'Numeric input with custom step (required, without error handling)' },
            NumberInput,
            {
